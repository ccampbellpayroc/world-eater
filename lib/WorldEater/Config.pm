    ...
    return {
        ...
        applications => [
            ...
            {   name               => 'authproxy',
                ...
                ignore_list        => [qw{ conf monitor Monitors log log-verbose var }]
            },
            {   name               => 'authproxy-monitors',
                repo_url           => 'git@github.com:payroc/cal-app-authproxy.git',
            ...
            {   name               => 'repay',
                ...
                ignore_list        => [qw{ *.lock log logs rps_client_interface.12 rps_scheduler.12 logrotate.status nohup.out }]
            },
            {   name               => 'trans-risk',
                repo_url           => 'git@github.com:payroc/cal-app-repay.git',
            ...
            {   name               => 'tokenator',
                repo_url           => 'git@github.com:payroc/cal-app-repay.git',
                repo_sub_directory => '/src/tokenator',
                server_name        => 'tokenator',
